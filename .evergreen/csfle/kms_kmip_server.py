...
def main():
    ...
    default_ca_file = os.path.join(drivers_evergreen_tools, ".evergreen", "x509gen", "ca.pem")
    default_cert_file = os.path.join(drivers_evergreen_tools, ".evergreen", "x509gen", "server.pem")
    ...
    parser.add_argument("--ca_file", type=str, default=default_ca_file, help="TLS CA PEM file")
    parser.add_argument(

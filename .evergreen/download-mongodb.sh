   ...
   case "$_DISTRO" in
      ...
      linux-rhel-9*)
         ...
         MONGOSH="https://downloads.mongodb.com/compass/mongosh-${VERSION_MONGOSH}-linux-x64.tgz"
             MONGODB_RAPID="http://downloads.10gen.com/linux/mongodb-linux-x86_64-enterprise-rhel93${DEBUG}-${VERSION_RAPID}.tgz"
      ...
      linux-rhel-8.2-aarch64)
         ...
         MONGOSH="https://downloads.mongodb.com/compass/mongosh-${VERSION_MONGOSH}-linux-arm64.tgz"
             ...
             MONGODB_80="http://downloads.10gen.com/linux/mongodb-linux-aarch64-enterprise-rhel88${DEBUG}-${VERSION_80}.tgz"
